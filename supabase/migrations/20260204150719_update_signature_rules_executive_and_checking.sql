/*
  # Update Signature Rules for Executive and Non-Executive Requesters

  1. Rules for Executive Requesters:
    - Cash Advance: Include first and second approver only
    - All other documents: Include only the first approver
  
  2. Rules for Non-Executive Requesters:
    - Cash Advance: Include all approved approvals
    - All other documents: Exclude approvers where for_checking = true

  3. Impact:
    - Executive requesters get simplified signatures (first approver only, or first two for Cash Advance)
    - Non-Executive requesters exclude checkers except for Cash Advance
*/
