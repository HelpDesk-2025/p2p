/*
  ...
  1. Changes
    - Add `no_of_pax` column to `petty_cash_requests` table
      - Integer field for tracking number of people
      - Optional field, can be null
      
  2. Purpose
    - Track the number of people involved in a petty cash request
    - Useful for budgeting and expense tracking purposes
*/
