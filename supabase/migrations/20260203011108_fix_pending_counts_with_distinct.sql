/*
  # Fix Pending Approval Counts - Use DISTINCT Sequences

  1. Problem
    - Multiple approval flow entries exist at the same sequence
    - OFFSET was skipping ROWS instead of SEQUENCES
    - Example: OFFSET 1 on [seq1, seq1, seq1, seq2, seq2] returns seq1 (row 2) not seq2
    
  2. Solution
    - Use DISTINCT to get unique sequences first
    - Then apply OFFSET to get the correct sequence level
*/
...
BEGIN
  ...
  LOOP
    -- Get the UNIQUE sequence number at current approval level
