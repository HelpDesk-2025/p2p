-- Fix the get_my_pending_approval_ids function which references cr.purchase_type 
-- on canvass_requests, but that column doesn't exist. This breaks canvass approval visibility.
