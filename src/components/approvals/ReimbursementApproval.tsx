...
import { CheckCircle, XCircle, Eye, X, ArrowRight, Loader2, Download, ArrowUpDown, ArrowUp, ArrowDown, CornerDownLeft, Paperclip } from 'lucide-react';
      ...
      if (action === 'approved' && isLastApproval) {
        ...
        try {
          ...
          const reimbursementFormBytes = await generateReimbursementForm({
            ...
            approvals: approvals,
            expenseCategory: selectedRequest.expense_category || 'Department Expense'
          });
