  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmationModal
        ...
        title="Approve Canvass Request?"
        message={`Are you sure you want to approve this canvass request (${selectedRequest?.document_no || selectedRequest?.canvass_number})? This action cannot be undone.`}
        confirmText="Approve"
        type="success"
        loading={loading}
      />
      ...
      <ConfirmationModal
        ...
        title="Reject Canvass Request?"
        message={`Are you sure you want to reject this canvass request (${selectedRequest?.document_no || selectedRequest?.canvass_number})? This will terminate the approval process.`}
        confirmText="Reject"
        type="danger"
        loading={loading}
      />
