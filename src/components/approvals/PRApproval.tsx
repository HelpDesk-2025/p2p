...
import { CheckCircle, XCircle, Eye, X, ArrowRight, FileText, Download, RefreshCw, Send, Loader2, ArrowUpDown, ArrowUp, ArrowDown, CornerDownLeft, History, ToggleLeft, ToggleRight, Paperclip } from 'lucide-react';
    ...
    <div className="space-y-4 lg:space-y-6 h-full">
              ...
              <div className="flex flex-wrap gap-3 pt-4 border-t border-slate-200">
                ...
                {selectedRequest.checklist_items && selectedRequest.checklist_items.length > 0 && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition font-semibold text-sm sm:text-base"
                  >
      ...
      {showChangeAttachmentModal && selectedRequest && (
        <ChangeAttachmentModal
          ...
          requestType="Purchase Requisition"
          requestId={selectedRequest.id}
          requestNumber={selectedRequest.pr_number}
