      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 sm:p-8">
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex justify-center mb-3">
            <img src="/p2p_logo.png" alt="Point to Point" className="h-16 w-auto object-contain" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Point to Point</h1>
