      ...
      content: [
        {
          ...
          steps: [
            ...
            'Select the request type (PO or Non-PO)',
            'Fill in all required fields marked with *',
            'Add line items with descriptions, quantities, and unit prices',
            'For PO requests: Select items from the dropdown',
            'For Non-PO requests: Click "Add Line" to add custom items',
            'Complete the procurement checklist by answering all questions',
            'Upload required attachments (quotations, specifications, etc.)',
