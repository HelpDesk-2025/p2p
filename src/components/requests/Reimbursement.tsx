    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
          <h2 className="font-display text-xl sm:text-2xl font-semibold text-slate-900">Reimbursement/Liquidation Requests</h2>
          <div className="flex items-center gap-2">
            <button
              ...
              paginatedRequests.map((req, index) => (
                ...
                >
                  <td className="px-3 xl:px-4 py-3 whitespace-nowrap">
                    <span className="font-mono font-bold text-sm text-blue-900 truncate block min-w-[120px]" title={req.reimb_number}>
                      {req.reimb_number}
                    </span>
                  </td>
                  <td className="px-3 xl:px-4 py-3 whitespace-nowrap">
